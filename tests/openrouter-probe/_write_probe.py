"""Helper: writes run_chat_paths_app.py with full content."""
import pathlib

TARGET = pathlib.Path(__file__).parent / "run_chat_paths_app.py"

CONTENT = r'''"""run_chat_paths_app.py -- Comprehensive all-layers chat probe for GLOW.
...
def layer1() -> None:
    ...
    _record("01", "free-model-ACB-font-question", ok, answer, data, layer=1)
...
print(f"Written: {len(CONTENT)} chars, {CONTENT.count(chr(10))} lines -> {TARGET}")
