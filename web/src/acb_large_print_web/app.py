...
def create_app(config: dict | None = None) -> Flask:
    ...
    def inject_rules():
        ...
        try:
            ...
            # Authentication flags (controls Create Account / Sign In visibility)
            ctx["user_login_enabled"] = bool(all_flags.get("GLOW_ENABLE_USER_LOGIN", False))
            ctx["admin_login_enabled"] = bool(all_flags.get("GLOW_ENABLE_ADMIN_LOGIN", True))
