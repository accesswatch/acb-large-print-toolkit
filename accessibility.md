...
| Rule | Count | Notes |
| --- | ---: | --- |
| `color-contrast` | 39 | Live production still reports incomplete/manual-review nodes on `/about/`, `/deployment/`, and `/prd/`; no confirmed contrast violations were reported. |
