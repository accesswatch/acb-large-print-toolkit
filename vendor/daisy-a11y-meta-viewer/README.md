...
The GLOW includes a Python port of this algorithm in `desktop/src/acb_large_print/epub_meta_display.py`. The Python implementation follows the same W3C specification independently and is used to enhance EPUB audit reports with human-readable accessibility metadata summaries.
