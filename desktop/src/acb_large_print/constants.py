...
AUDIT_RULES: dict[str, RuleDef] = {
    ...
    "XLSX-BLANK-ROWS-LAYOUT": RuleDef(
        rule_id="XLSX-BLANK-ROWS-LAYOUT",
        description="Multiple consecutive blank rows are used for visual spacing instead of row-height settings, disrupting screen reader navigation",
        severity=Severity.MEDIUM,
        acb_reference="WCAG 1.3.2 Meaningful Sequence",
        category=RuleCategory.MSAC,
        auto_fixable=False,
    ...
    "XLSX-DEFAULT-TABLE-NAME": RuleDef(
        rule_id="XLSX-DEFAULT-TABLE-NAME",
        description="Excel Table has a default auto-generated name (Table1, Table2) rather than a descriptive label",
        severity=Severity.LOW,
        acb_reference="WCAG 2.4.6 Headings and Labels",
        category=RuleCategory.MSAC,
        auto_fixable=False,
    ...
    # -- Timing and animation (WCAG 2.2 / 2.3) --
    "PPTX-FAST-AUTO-ADVANCE": RuleDef(
        rule_id="PPTX-FAST-AUTO-ADVANCE",
        description="Slide auto-advances in less than 3 seconds, denying users sufficient reading time",
        severity=Severity.HIGH,
        acb_reference="WCAG 2.2.1 Timing Adjustable",
        category=RuleCategory.MSAC,
        auto_fixable=False,
        formats=_PPTX_ONLY,
    ),
    "PPTX-REPEATING-ANIMATION": RuleDef(
        rule_id="PPTX-REPEATING-ANIMATION",
        description="Slide contains a looping or indefinitely repeating animation that users cannot pause",
        severity=Severity.HIGH,
        acb_reference="WCAG 2.2.2 Pause, Stop, Hide",
        category=RuleCategory.MSAC,
        auto_fixable=False,
        formats=_PPTX_ONLY,
    ),
    "PPTX-RAPID-AUTO-ANIMATION": RuleDef(
        rule_id="PPTX-RAPID-AUTO-ANIMATION",
        description="Slide has multiple auto-start animations with delays under 1 second, creating rapid distracting motion",
        severity=Severity.MEDIUM,
        acb_reference="WCAG 2.2.2 Pause, Stop, Hide",
        category=RuleCategory.MSAC,
        auto_fixable=False,
    ...
    "PPTX-FAST-TRANSITION": RuleDef(
        rule_id="PPTX-FAST-TRANSITION",
        description="Slide transition speed is set to Fast, which may be disorienting for users with cognitive or vestibular disabilities",
        severity=Severity.LOW,
        acb_reference="WCAG 2.3.3 Animation from Interactions",
        category=RuleCategory.MSAC,
        auto_fixable=False,
        formats=_PPTX_ONLY,
    ),
    ...
    "MD-EMPTY-LINK-TEXT": RuleDef(
        rule_id="MD-EMPTY-LINK-TEXT",
    ...
    "MD-URL-AS-LINK-TEXT": RuleDef(
        rule_id="MD-URL-AS-LINK-TEXT",
    ...
    # -- Alt text quality (Phases 2) --
    "MD-ALT-TEXT-FILENAME": RuleDef(
        rule_id="MD-ALT-TEXT-FILENAME",
    ...
    "MD-ALT-TEXT-REDUNDANT-PREFIX": RuleDef(
        rule_id="MD-ALT-TEXT-REDUNDANT-PREFIX",
    ...
    "MD-ALT-TEXT-TOO-SHORT": RuleDef(
        rule_id="MD-ALT-TEXT-TOO-SHORT",
    ...
    # -- YAML front matter gate (Phase 3) --
    "MD-NO-YAML-FRONT-MATTER": RuleDef(
        rule_id="MD-NO-YAML-FRONT-MATTER",
    ...
    "MD-YAML-UNCLOSED-FENCE": RuleDef(
        rule_id="MD-YAML-UNCLOSED-FENCE",
    ...
    "MD-YAML-MISSING-TITLE": RuleDef(
        rule_id="MD-YAML-MISSING-TITLE",
    ...
    "MD-YAML-MISSING-LANG": RuleDef(
        rule_id="MD-YAML-MISSING-LANG",
    ...
    "MD-YAML-MISSING-AUTHOR": RuleDef(
        rule_id="MD-YAML-MISSING-AUTHOR",
    ...
    "MD-YAML-MISSING-DESCRIPTION": RuleDef(
        rule_id="MD-YAML-MISSING-DESCRIPTION",
    ...
    # -- Heading quality (Phase 6) --
    "MD-NO-HEADINGS": RuleDef(
        rule_id="MD-NO-HEADINGS",
    ...
    "MD-DUPLICATE-HEADING-TEXT": RuleDef(
        rule_id="MD-DUPLICATE-HEADING-TEXT",
    ...
    "MD-LONG-SECTION-WITHOUT-HEADING": RuleDef(
        rule_id="MD-LONG-SECTION-WITHOUT-HEADING",
    ...
    "MD-EMPTY-HEADING": RuleDef(
        rule_id="MD-EMPTY-HEADING",
    ...
    "MD-HEADING-TOO-LONG": RuleDef(
        rule_id="MD-HEADING-TOO-LONG",
    ...
    "MD-HEADING-ENDS-PUNCTUATION": RuleDef(
        rule_id="MD-HEADING-ENDS-PUNCTUATION",
    ...
    # -- Code block accessibility (Phase 6) --
    "MD-CODE-BLOCK-NO-LANGUAGE": RuleDef(
        rule_id="MD-CODE-BLOCK-NO-LANGUAGE",
    ...
    "MD-INDENTED-CODE-BLOCK": RuleDef(
        rule_id="MD-INDENTED-CODE-BLOCK",
    ...
    # -- Raw HTML in Markdown (Phase 6) --
    "MD-RAW-HTML-TABLE": RuleDef(
        rule_id="MD-RAW-HTML-TABLE",
    ...
    "MD-MOVING-CONTENT": RuleDef(
        rule_id="MD-MOVING-CONTENT",
    ...
    "MD-RAW-BR-TAG": RuleDef(
        rule_id="MD-RAW-BR-TAG",
        description="Raw HTML <br> tag used in Markdown",
        severity=Severity.LOW,
        acb_reference="CommonMark portability and structure",
        category=RuleCategory.MSAC,
        auto_fixable=False,
        formats=_MD_ONLY,
    ),
    "MD-RAW-HTML-GENERIC-CONTAINER": RuleDef(
        rule_id="MD-RAW-HTML-GENERIC-CONTAINER",
    ...
    "MD-RAW-HTML-PRESENTATIONAL": RuleDef(
        rule_id="MD-RAW-HTML-PRESENTATIONAL",
    ...
    # -- Table structure quality (Phase 6) --
    "MD-BLANK-TABLE-HEADER": RuleDef(
        rule_id="MD-BLANK-TABLE-HEADER",
    ...
    "MD-TABLE-COLUMN-MISMATCH": RuleDef(
        rule_id="MD-TABLE-COLUMN-MISMATCH",
    ...
    # -- Fake list patterns (Phase 6) --
    "MD-FAKE-LIST-BULLET": RuleDef(
        rule_id="MD-FAKE-LIST-BULLET",
    ...
    "MD-FAKE-NUMBERED-LIST": RuleDef(
        rule_id="MD-FAKE-NUMBERED-LIST",
    ...
    "MD-FAKE-INLINE-BULLET": RuleDef(
        rule_id="MD-FAKE-INLINE-BULLET",
    ...
    "MD-EXCESSIVE-BLANK-LINES": RuleDef(
        rule_id="MD-EXCESSIVE-BLANK-LINES",
        description="Three or more consecutive blank lines reduce readability and structural consistency",
        severity=Severity.LOW,
        acb_reference="ACB readability quality",
        category=RuleCategory.MSAC,
        auto_fixable=False,
        formats=_MD_ONLY,
    ),
    "MD-EXCESSIVE-TRAILING-SPACES": RuleDef(
        rule_id="MD-EXCESSIVE-TRAILING-SPACES",
        description="Line ends with more than two trailing spaces",
        severity=Severity.LOW,
        acb_reference="CommonMark line break behavior",
        category=RuleCategory.MSAC,
        auto_fixable=False,
        formats=_MD_ONLY,
    ),
    "MD-ENTIRE-LINE-BOLDED": RuleDef(
        rule_id="MD-ENTIRE-LINE-BOLDED",
    ...
    "MD-ALLCAPS": RuleDef(
        ...
        severity=Severity.MEDIUM,
        acb_reference="ACB Guidelines Section 2: Capitalization; WCAG 1.4.8",
        category=RuleCategory.ACB,
        auto_fixable=False,
        formats=_MD_ONLY,
    ),
    ...
    "PDF-IMAGE-RESOLUTION": RuleDef(
        rule_id="PDF-IMAGE-RESOLUTION",
        description="Images on scanned pages are below 150 DPI, making OCR and remediation unreliable",
        severity=Severity.HIGH,
        acb_reference="WCAG 1.4.5 Images of Text",
        category=RuleCategory.MSAC,
        auto_fixable=False,
    ...
    "EPUBCHECK-ERROR": RuleDef(
        rule_id="EPUBCHECK-ERROR",
    ...
    "EPUBCHECK-WARNING": RuleDef(
        rule_id="EPUBCHECK-WARNING",
